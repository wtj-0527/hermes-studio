...
const HERMES_STUDIO_SPLIT_MCP_TOOLS = new Map([
  ...
  ['mcp__hermes_studio_browser', [categoryToolset(
    ...
    'Discover and invoke Hermes Studio browser operations through ElectronBrowserProvider on Desktop or SteelBrowserProvider on Web. Covers tabs and leases, navigation, accessibility snapshots, interaction, screenshots, and console logs.',
  )]],
