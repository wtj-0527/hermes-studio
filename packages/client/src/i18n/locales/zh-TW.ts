export default {
  ...
  workflow: {
    ...
    orchestration: {
      invalidCondition: '條件無效，請輸入有效的條件路徑和運算子。',
      feedbackLoop: '回饋循環',
      maxIterations: '最大迭代次數',
      edgePolicy: '連線策略', editEdge: '編輯連線策略', condition: '條件', path: '條件路徑', value: '條件值（JSON 或文字）', joinMode: '匯合模式', joinAll: '等待所有入站路由', joinAny: '任一入站路由命中時執行',
    },
    portability: {
      export: '匯出',
      import: '匯入',
      ...
      importFailed: '匯入失敗',
      imported: '工作流已匯入',
      invalidJson: '工作流 JSON 無效',
      tooLarge: '工作流檔案超過 1 MiB',
      missing: '缺少相依項目',
      warnings: '警告',
      profiles: '設定檔',
      agents: '智慧體',
      ...
      models: '模型',
      skills: '技能',
      inactiveNotice: '匯入會建立新的未執行工作流，且絕不會自動啟動。',
      confirmImport: '確認匯入',
    },
    workspace: {
      title: '選擇工作區',
